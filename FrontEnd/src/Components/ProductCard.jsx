...
const ProductCard = ({product}) => {
    const {currency,addToCart,removeFormCart,
        cartItems={},navigate} =useAppContext();
                ...
                <div className="flex items-end justify-between mt-3  ">
                    ...
                    <div onClick={(e)=>{e.stopPropagation();}} className="text-primary">
                        ...
                        {!cartItems [product._id] ? (
                            <button className="flex items-center justify-center gap-1 cursor-pointer bg-primary/10 border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded  font-medium"
                            ...
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-primary/25 rounded select-none">
                                <button onClick={() => {removeFormCart(product._id)}} className="cursor-pointer text-md px-2 h-full" >
                                    -
                                </button>
