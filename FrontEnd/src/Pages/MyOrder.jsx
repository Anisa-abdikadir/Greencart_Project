                ...
                <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl'>
...

                    {
                        order.items.map((item,index)=>(
                            ...
                            <div key={index}
                            className={`relative  bg-white text-gray-50-/70 ${
                                order.items.length !== index+1 && "border-b " //check order 
                                ...
                                <div className='flex flex-col text-gray-500 justify-center  md:ml-8 mb-4  md:mb-0'>
