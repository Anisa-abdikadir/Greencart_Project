...
const InputField=({type,placeholder,name,handleChange,address})=>(
        <input type={type} placeholder={placeholder} name={name} onChange={handleChange} value={address[name]}
         required className="w-full px-2 py-2.5 border border-gray-500/30 rounded outline-none
...
const AddAddress = () => {
  ...
  return (
    <div className=' mx-auto mt-16 pb-16'>
                    ...
                    <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-2 gap-4'>
                          ...
                          <InputField  handleChange={handleChange} address={address}
                            ...
                            <button type='submit' className='w-full mt-6 bg-primary text-white py-2 hover:bg-primary-dull
                            transition duration-300 cursor-pointer uppercase'>Save Address</button>
